...
const meta = {
  name: "capsule",
  category: "geometric",
  description: "Horizontal capsule centered at the origin",
  params: [
    {
      name: "width",
      type: "number",
      default: 120,
      semantic: "capsule width in px",
    },
    {
      name: "height",
      type: "number",
      default: 52,
      semantic: "capsule height in px",
    },
    {
      name: "fill",
      type: "color",
...
function capsule(layer = {}) {
  const width = Math.max(2, num(layer.width, 120));
  const height = Math.max(2, num(layer.height, 52));
