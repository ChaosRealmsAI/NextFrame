...
- 详细架构见 `spec/versions/v1.0/pm-docs/ultimate-architecture.html`。
...
1. 先读 roadmap：`cat spec/roadmap.json` → 确认当前版本阶段（v2.0 应在 prototype/spec/architecture）
2. 再读架构文档：`spec/versions/v1.0/pm-docs/ultimate-architecture.html`（v2.0 的北极星）
3. 读 ADR（如有）：`spec/adrs.json`
...
- **新 src/ 骨架**：规划见 `spec/versions/v1.0/pm-docs/ultimate-architecture.html`
- **架构北极星**：`spec/versions/v1.0/pm-docs/ultimate-architecture.html`
- **roadmap**：`spec/roadmap.json`
- **ADRs**：`spec/adrs.json`
- **Standards**：`spec/standards/00-index.md`
- **BDD**：`spec/versions/v2.0/bdd/`
