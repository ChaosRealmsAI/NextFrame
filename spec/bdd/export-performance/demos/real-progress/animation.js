...
document.querySelector("#app").innerHTML = `
  ...
  <section class="body">
    ...
    <aside>
      <div class="label">Progress</div><div class="button">导出中</div>
      ...
      <div class="status">stage=render · percent follows record.encode_progress</div><button class="button open">打开视频</button>
    </aside>
