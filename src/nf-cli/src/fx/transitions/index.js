...
import { slideLeftT } from "./slideLeftT.js";
import { slideRightT } from "./slideRightT.js";
...
export const TRANSITION_TABLE = {
  ...
  slideLeftT:  { id: "slideLeftT",  description: "Slide in from left",              params: [{ name: "dur", type: "number", default: 0.6 }] },
  slideRightT: { id: "slideRightT", description: "Slide in from right",             params: [{ name: "dur", type: "number", default: 0.6 }] },
  push:        { id: "push",        description: "Push A out, B in from right",     params: [{ name: "dur", type: "number", default: 0.6 }] },
};

export const TRANSITION_FNS = { dissolve, wipeLeft, wipeUp, wipeRight, wipeDown, zoomIn, fadeBlack, fadeWhite, irisOpen, irisClose, slideLeftT, slideRightT, push };
