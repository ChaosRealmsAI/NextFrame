...
use nf_recorder::verify_mp4::{self, VerifyError};

fn battle_mp4_path() -> PathBuf {
    // Test runs from crate root (src/nf-recorder) · tmp lives at workspace root.
    // Try several candidates to be portable between `cargo test -p nf-recorder`
