...
function loadEpisodes() {
  ...
  bridgeCall('episode.list', { project: window.currentProjectPath }).then(function(data: any) {
    ...
    episodes.forEach(function(ep: any, i: any) {
...
function openEpisode(path: any, name: any) {
