...
function formatClock(totalSeconds: any, withTenths: any) {
...
function humanizeSlug(value: any) {
  return String(value || '')
    .split(/[-_]+/)
    .filter(Boolean)
...
function formatSourceTitle(source: any, index: any) {
...
function normalizeSegmentPreviewParams(segmentName: any) {
  return {
...
function fallbackSegmentPreviewParams(segmentName: any) {
  return {
...
window.formatEditorTimecode = (seconds: any) => formatClock(seconds, true);
