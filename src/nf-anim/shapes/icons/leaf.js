...
const meta = {
  name: "leaf",
  category: "icons",
  description: "Leaf icon centered in a 100x100 box",
  params: [
    {
      name: "fill",
      type: "color",
...
function leaf(layer = {}) {
  ...
  const body = [
    "M 0,-50 C 34,-50 52,-24 47,7",
    "C 42,38 17,54 0,58 C -17,54 -42,38 -47,7",
    "C -52,-24 -34,-50 0,-50 Z",
  ].join(" ");
  return `<g><path${attrs({
    d: body,
    fill,
    ...
    d: "M -3,42 C 2,10 16,-11 34,-30",
    fill: "none",
    stroke: vein,
    "stroke-width": Math.max(strokeWidth || 0, 4),
