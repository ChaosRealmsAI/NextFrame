...
const meta = {
  name: "flame",
  category: "icons",
  description: "Flame icon centered in a 100x100 box",
  params: [
    {
      name: "fill",
      type: "color",
...
function flame(layer = {}) {
  ...
  const d = [
    "M 10,-54 C 22,-34 10,-21 21,-6",
    "C 34,9 38,22 35,35 C 31,53 16,64 0,64",
    "C -22,64 -38,47 -38,24 C -38,2 -26,-12 -12,-27",
    "C -1,-39 4,-47 10,-54 Z",
    "M 0,-10 C -10,5 -16,15 -16,26",
    "C -16,37 -9,45 0,45 C 10,45 17,37 17,26 C 17,14 10,5 0,-10 Z",
  ].join(" ");
  return `<path${attrs({
    d,
    fill,
