...
export const ENTRANCE_BEHAVIORS = { fadeIn, slideInLeft, slideInRight, slideInUp, slideInDown, scaleIn, blurIn, springIn, popIn, unfold, wipeReveal, drawIn };
export function listBehaviors() { return Object.values(ENTRANCE_BEHAVIORS).map((entry) => entry.meta || entry); }
export { meta };
